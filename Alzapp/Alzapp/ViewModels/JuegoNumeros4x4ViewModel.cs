...
namespace Alzapp.ViewModels
{
    ...
    public class JuegoNumeros4x4ViewModel : BaseViewModel
    {
        ...
        public string boton12;
        public string boton13;
        public string boton14;
        public string boton15;
        ...
        {
            get => boton12;
            set => SetValue(ref boton12, value);
        }
        public string Boton13
        {
            get => boton13;
            set => SetValue(ref boton13, value);
        }
        public string Boton14
        {
            get => boton14;
            set => SetValue(ref boton14, value);
        }
        public string Boton15
        {
            get => boton15;
            set => SetValue(ref boton15, value);
        }
        ...
        public ICommand ComprobarCommand12 => new RelayCommand(ComprobarOnClick12);
        public ICommand ComprobarCommand13 => new RelayCommand(ComprobarOnClick13);
        public ICommand ComprobarCommand14 => new RelayCommand(ComprobarOnClick14);
        public ICommand ComprobarCommand15 => new RelayCommand(ComprobarOnClick15);
        ...
        private readonly string[] botonera = new string[16];
        private string fondo;

        public string var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, var14, var15;
        ...
        public bool bloqueo12;
        public bool bloqueo13;
        public bool bloqueo14;
        public bool bloqueo15;
        private string NumeroCorrecto;


        public JuegoNumeros4x4ViewModel()
        {
            fondo = "FondoJuego";
            CargarImagenes();
            Iniciar();
        ...
        public async void ComprobarOnClick12()
        {
            if (bloqueoTotal == true)
            {
                return;
        ...
        public async void ComprobarOnClick13()
        {
            if (bloqueoTotal == true)
            {
                return;
        ...
        public async void ComprobarOnClick14()
        {
            if (bloqueoTotal == true)
            {
                return;
        ...
        public async void ComprobarOnClick15()
        {
            if (bloqueoTotal == true)
            {
                return;
        ...
        public void SubirNumeroCorrecto()
        {
            ...
            if (NumeroCorrecto == "numerodoce")
            {
                NumeroCorrecto = "numerotrece";
                return;
            }
            if (NumeroCorrecto == "numerotrece")
            {
                NumeroCorrecto = "numerocatorce";
                return;
            }
            if (NumeroCorrecto == "numerocatorce")
            {
                NumeroCorrecto = "numeroquince";
                return;
            }            
            if (NumeroCorrecto == "numeroquince")
            {
                NumeroCorrecto = "numerodieciseis";
                return;
            }
            return;
