...
namespace Alzapp.ViewModels
{
    ...
    public class FotoCuidadorViewModel : BaseViewModel
    {
        ...
        public ICommand AddFotoCommand => new RelayCommand(AddFoto);
        public ICommand RefreshCommand => new RelayCommand(RefreshFotosList);
        public FotoCuidadorViewModel()
        {
            LoadFotos();
        }
        ...
        public void AddFotoToList(Foto foto)
        {
            this.myFotos.Add(foto);
            this.RefreshFotosList();
        }
        ...
        public async void AddFoto()
        {
            MainViewModel.GetInstance().AddFoto = new AddFotoViewModel();
            await Application.Current.MainPage.Navigation.PushAsync(new AddFotoPage());
        }
