namespace Alzapp.ViewModels
{
    ...
    public class JuegoNumeros3x3ViewModel : BaseViewModel
    {
        ...
        private readonly string[] botonera = new string[9];
        private string fondo;

        public string var0, var1, var2, var3, var4, var5, var6, var7, var8;
        ...
        public JuegoNumeros3x3ViewModel()
        {
            fondo = "FondoJuego";
            CargarImagenes();
            Iniciar();
